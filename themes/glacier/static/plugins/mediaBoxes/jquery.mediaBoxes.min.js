 ...
 * ====================================================================== */    
    ...
    MediaBoxes.DEFAULTS = {
        ...
        noEmptySpaceOnThumbWithRatio    : false, // Make thumbnail automatically adapt to the 100% of its container (so no black space)
        thumbnailOverlay                : true, //Show the overlay on mouse over
        overlayEffect                   : 'fade', // 'push-up', 'push-down', 'push-up-100%', 'push-down-100%', 'reveal-top', 'reveal-bottom', 'reveal-top-100%', 'reveal-bottom-100%', 'direction-aware', 'direction-aware-fade', 'direction-right', 'direction-left', 'direction-top', 'direction-bottom', 'fade'
        overlaySpeed                    : 200,
        overlayEasing                   : 'default',
        showOnlyVisibleBoxesInPopup     : true,
 ...
 * ====================================================================== */    
     ...
     * ====================================================================== */
        ...
        /* Load more button */
        var loadMoreButton              = $('.media-boxes-load-more-button');
     ...
     * ====================================================================== */
        ...
        function finishLoading(){
            ...
            loadMoreButton.addClass("show-button-load-more");
        ...
        loadMoreButton.on('click', function(){
            ...
            setTimeout(function() {
                if ($('video, audio').length) {
                    $('video, audio')[0].player.setPlayerSize();
                }
                $container.isotopeMB('layout');  
            }, 100);
     ...
     * ====================================================================== */    
        ...
        function setupOverlayForHoverEffect(container){
            ...
            boxes.each(function(){
                ...
                }else if( effect.substr(0, 9) == 'classic'){ // 'direction-aware', 'direction-aware-fade', 'direction-right', 'direction-left', 'direction-top', 'direction-bottom'
     ...
     * ====================================================================== */
        ...
        function addSocialButtons(item){
            ...
            if(settings.twitter != undefined){//Twitter
              social+="<div class='media-boxes-twitter fa-brands fa-x-twitter' data-url='"+sharingURL+"'></div>";
            }
